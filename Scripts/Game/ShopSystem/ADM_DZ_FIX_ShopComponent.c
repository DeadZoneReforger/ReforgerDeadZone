modded class ADM_ShopComponentClass: ADM_ShopBaseComponentClass {}
modded class ADM_ShopComponent: ADM_ShopBaseComponent
{
    ...
    override array<ref ADM_ShopCategory> GetCategories()
    {
